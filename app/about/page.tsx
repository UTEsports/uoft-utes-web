  ...
  return (
    <main>
      ...
      <MaxWidthWrapper className="px-10">
        {/* Hero section */}
        <h3 className="mt-12 max-sm:text-4xl max-sm:text-center text-primary text-6xl font-bold">
        ...
        <a href="/contact">
          <button className="bt text-white bg-cyan-500 rounded-full px-12 py-3 text-2xl font-semibold duration-50 hover:scale-105 active:scale-95 hover:bg-cyan-600">
            Contact Us
          </button>
        </a>
      </MaxWidthWrapper>

      <MaxWidthWrapper className="pt-20 px-10">
        <h1 className="mt-12 max-sm:text-4xl max-sm:text-center text-primary text-6xl font-bold mb-6">
          What We Do
        </h1>
